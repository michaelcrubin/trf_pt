## Data Space {#sec-energy-intro .unnumbered}
...
Which means that our data space is `r nrow(damage_grid)`. Our data set covers `r round(sum(damage_grid$n_data)/nrow(damage_grid)*100, 3)`% of the data space.
